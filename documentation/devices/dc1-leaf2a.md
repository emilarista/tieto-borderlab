...
| --------- | --------------- | ------------ | --------- |
| dc1-leaf2 | Vlan4094 | 100.64.14.5 | Port-Channel2 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet2 | MLAG_PEER_dc1-leaf2b_Ethernet2 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 2 |
| Ethernet3 | MLAG_PEER_dc1-leaf2b_Ethernet3 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 2 |
| Ethernet4 | B_SERVER1_Ethernet1 | *trunk | *110,120,130 | *- | *- | 4 |
...
!
interface Ethernet2
   description MLAG_PEER_dc1-leaf2b_Ethernet2
   no shutdown
...
!
interface Ethernet4
   description B_SERVER1_Ethernet1
   no shutdown
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel2 | MLAG_PEER_dc1-leaf2b_Po2 | switched | trunk | 2-4094 | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
| Port-Channel4 | B_SERVER1_ | switched | trunk | 110,120,130 | - | - | - | - | 4 | - |
...
interface Port-Channel2
   description MLAG_PEER_dc1-leaf2b_Po2
   no shutdown
   switchport
...
| --------- | ----------- | --- | ---- | -------- |
| Vlan110 | TENANT_B_INSIDE_L3_TEST_1 | TENANT_B_INSIDE | - | false |
| Vlan120 | TENANT_B_INSIDE_L3_TEST_2 | TENANT_B_INSIDE | - | false |
| Vlan130 | TENANT_B_INSIDE_L3_TEST_3 | TENANT_B_INSIDE | - | false |
| Vlan3019 | MLAG_PEER_L3_iBGP: vrf TENANT_B_INSIDE | TENANT_B_INSIDE | 1500 | false |
...
| --------- | --- | ---------- | ------------------ | ------------------------- | ---- | ------ | ------- |
| Vlan110 |  TENANT_B_INSIDE  |  -  |  10.0.11.1/24  |  -  |  -  |  -  |  -  |
| Vlan120 |  TENANT_B_INSIDE  |  -  |  10.0.12.1/24  |  -  |  -  |  -  |  -  |
| Vlan130 |  TENANT_B_INSIDE  |  -  |  10.0.13.1/24  |  -  |  -  |  -  |  -  |
...
| 100.64.13.5 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | TENANT_B_INSIDE | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 110 | 100.64.11.13:20110 | 65000:20110 | - | - | learned |
| 120 | 100.64.11.13:20120 | 65000:20120 | - | - | learned |
| 130 | 100.64.11.13:20130 | 65000:20130 | - | - | learned |

### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| TENANT_B_INSIDE | 100.64.11.13:20 | connected |
...
router bgp 65102
   ...
   neighbor 100.64.13.5 description dc1-leaf2b
   redistribute connected route-map RM-CONN-2-BGP
   !
   vlan 110
      rd 100.64.11.13:20110
      route-target both 65000:20110
      redistribute learned
   !
   vlan 120
      rd 100.64.11.13:20120
      route-target both 65000:20120
      redistribute learned
   !
   vlan 130
      rd 100.64.11.13:20130
