...
| --------- | --------------- | ------------ | --------- |
| dc1-leaf1 | Vlan4094 | 100.64.14.1 | Port-Channel2 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet2 | MLAG_PEER_dc1-leaf1b_Ethernet2 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 2 |
| Ethernet3 | MLAG_PEER_dc1-leaf1b_Ethernet3 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 2 |
| Ethernet4 | A_SERVER1_Ethernet1 | *trunk | *10,20,30 | *- | *- | 4 |
...
!
interface Ethernet2
   description MLAG_PEER_dc1-leaf1b_Ethernet2
   no shutdown
...
!
interface Ethernet4
   description A_SERVER1_Ethernet1
   no shutdown
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel2 | MLAG_PEER_dc1-leaf1b_Po2 | switched | trunk | 2-4094 | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
interface Port-Channel2
   description MLAG_PEER_dc1-leaf1b_Po2
   no shutdown
   switchport
...
| 100.64.13.1 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | TENANT_A_INSIDE | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 10 | 100.64.11.11:10010 | 65000:10010 | - | - | learned |
| 20 | 100.64.11.11:10020 | 65000:10020 | - | - | learned |
| 30 | 100.64.11.11:10030 | 65000:10030 | - | - | learned |

### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| TENANT_A_INSIDE | 100.64.11.11:10 | connected |
...
router bgp 65101
   ...
   neighbor 100.64.13.1 description dc1-leaf1b
