...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 10.83.31.236/22 | 10.83.28.1 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_dc2-bleaf1a_Ethernet4 | routed | - | 100.70.11.5/31 | default | 1500 | false | - | - |
| Ethernet2 | P2P_LINK_TO_dc2-bleaf1b_Ethernet4 | routed | - | 100.70.11.7/31 | default | 1500 | false | - | - |
| Ethernet3 | P2P_LINK_TO_bb1_Ethernet3 | routed | - | 100.70.10.5/31 | default | 1500 | false | - | - |
| Ethernet4 | P2P_LINK_TO_pe2_Ethernet1 | routed | - | 100.70.10.2/31 | default | 1500 | false | - | - |
...
!
interface Ethernet1
   description P2P_LINK_TO_dc2-bleaf1a_Ethernet4
   no shutdown
   mtu 1500
   no switchport
   ip address 100.70.11.5/31
   mpls ip
   isis enable CORE
...
!
interface Ethernet2
   description P2P_LINK_TO_dc2-bleaf1b_Ethernet4
   no shutdown
   mtu 1500
   no switchport
   ip address 100.70.11.7/31
   mpls ip
   isis enable CORE
   isis circuit-type level-2
   isis metric 50
...
| -------- | ----- |
| Instance | CORE |
| Net-ID | 49.0001.0000.0011.0002.00 |
| Type | level-2 |
...
| 100.70.0.1 | Inherited from peer group RR-OVERLAY-PEERS | default | - | Inherited from peer group RR-OVERLAY-PEERS | Inherited from peer group RR-OVERLAY-PEERS | - | Inherited from peer group RR-OVERLAY-PEERS | - |
...
router bgp 65000
   ...
   neighbor 100.70.0.1 peer group RR-OVERLAY-PEERS
