...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_DC2-SPINE1_Ethernet6 | routed | - | 100.64.20.41/31 | default | 1500 | false | - | - |
| Ethernet2 | P2P_LINK_TO_SOME_P_ROUTER_Ethernet2 | routed | - | 100.70.255.2/31 | default | 1500 | false | - | - |
...
!
interface Ethernet2
   description P2P_LINK_TO_SOME_P_ROUTER_Ethernet2
   no shutdown
   mtu 1500
   speed forced 40gfull
   no switchport
   ip address 100.70.255.2/31
   mpls ldp igp sync
   mpls ldp interface
   mpls ip
...
| Loopback1 | VTEP_VXLAN_Tunnel_Source | default | 100.64.22.16/32 <br> 100.64.255.255/32 secondary |
...
!
interface Vxlan1
   description dc2-jn1-2-l3border2_VTEP
   vxlan source-interface Loopback1
   vxlan udp-port 4789
   vxlan vrf JN1_VRF1 vni 11
   vxlan vrf JN2_VRF_1 vni 21
```
...
!
ip routing
ip routing vrf JN1_VRF1
ip routing vrf JN2_VRF_1
...
| ---------- | --------- | ------------------------- | -------------------- | --- | ------- | ----------------------------- | ---------------------------- | ----------------------------- | ------------- | --------------------- | ------------------ |
| 100 | 100.64.21.16 | enabled | Ethernet1 <br> Ethernet2 <br> | disabled | 12000 | disabled | disabled | - | - | - | - |
...
| 100.70.0.1 | 64512 | default | - | Inherited from peer group MPLS-VPN-RR-PEERS | Inherited from peer group MPLS-VPN-RR-PEERS | - | Inherited from peer group MPLS-VPN-RR-PEERS | - |
| 100.70.0.2 | 64512 | default | - | Inherited from peer group MPLS-VPN-RR-PEERS | Inherited from peer group MPLS-VPN-RR-PEERS | - | Inherited from peer group MPLS-VPN-RR-PEERS | - |
...
| --- | ------------------- | ------------ |
| JN1_VRF1 | 100.64.21.16:11 | connected |
| JN2_VRF_1 | 100.64.21.16:21 | connected |
...
router bgp 65205
   ...
   neighbor MPLS-VPN-RR-PEERS maximum-routes 10000
   neighbor 100.64.20.40 peer group IPv4-UNDERLAY-PEERS
   neighbor 100.64.20.40 remote-as 65002
   neighbor 100.64.20.40 description dc2-spine1_Ethernet6
...
```eos
!
vrf instance JN1_VRF1
!
vrf instance JN2_VRF_1
!
vrf instance MGMT
```
