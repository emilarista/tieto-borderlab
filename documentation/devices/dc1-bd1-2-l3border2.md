...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_DC1-SPINE1_Ethernet8 | routed | - | 100.64.10.57/31 | default | 1500 | false | - | - |
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 100.64.11.18/32 |
| Loopback1 | VTEP_VXLAN_Tunnel_Source | default | 100.64.12.18/32 <br> 100.64.255.255/32 secondary |
...
interface Loopback0
   ...
   no shutdown
   ip address 100.64.11.18/32
!
interface Loopback1
   description VTEP_VXLAN_Tunnel_Source
   no shutdown
   ip address 100.64.12.18/32
...
!
interface Vxlan1
   description dc1-bd1-2-l3border2_VTEP
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- |
| 100.64.10.56 | 65001 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - |
...
| --- | ------------------- | ------------ |
| BD2_VRF1 | 100.64.11.18:41 | connected |
...
router bgp 65106
   ...
   neighbor 100.64.10.56 peer group IPv4-UNDERLAY-PEERS
   neighbor 100.64.10.56 remote-as 65001
   neighbor 100.64.10.56 description dc1-spine1_Ethernet8
