...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_DC2-SPINE1_Ethernet7 | routed | - | 100.64.20.49/31 | default | 1500 | false | - | - |
...
!
interface Ethernet1
   description P2P_LINK_TO_DC2-SPINE1_Ethernet7
   no shutdown
   mtu 1500
   no switchport
   ip address 100.64.20.49/31
```
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 100.64.21.17/32 |
| Loopback1 | VTEP_VXLAN_Tunnel_Source | default | 100.64.22.17/32 <br> 100.64.255.255/32 secondary |
...
interface Loopback0
   ...
   no shutdown
   ip address 100.64.21.17/32
!
interface Loopback1
   description VTEP_VXLAN_Tunnel_Source
   no shutdown
   ip address 100.64.22.17/32
...
!
interface Vxlan1
   description dc2-bd1-2-l3border1_VTEP
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- |
| 100.64.20.48 | 65002 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - |
...
| --- | ------------------- | ------------ |
| BD2_VRF1 | 100.64.21.17:41 | connected |
...
router bgp 65206
   ...
   neighbor 100.64.20.48 peer group IPv4-UNDERLAY-PEERS
   neighbor 100.64.20.48 remote-as 65002
   neighbor 100.64.20.48 description dc2-spine1_Ethernet7
