...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_DC2-SPINE1_Ethernet5 | routed | - | 100.64.20.33/31 | default | 1500 | false | - | - |
| Ethernet2 | P2P_LINK_TO_SOME_P_ROUTER_Ethernet1 | routed | - | 100.70.255.0/31 | default | 1500 | false | - | - |
...
!
interface Ethernet2
   description P2P_LINK_TO_SOME_P_ROUTER_Ethernet1
   no shutdown
   mtu 1500
   speed forced 40gfull
   no switchport
   ip address 100.70.255.0/31
   mpls ldp igp sync
   mpls ldp interface
   mpls ip
...
| Loopback1 | VTEP_VXLAN_Tunnel_Source | default | 100.64.22.15/32 <br> 100.64.255.255/32 secondary |
...
!
interface Vxlan1
   description dc2-jn1-2-l3border1_VTEP
...
| ---------- | --------- | ------------------------- | -------------------- | --- | ------- | ----------------------------- | ---------------------------- | ----------------------------- | ------------- | --------------------- | ------------------ |
| 100 | 100.64.21.15 | enabled | Ethernet1 <br> Ethernet2 <br> | disabled | 12000 | disabled | disabled | - | - | - | - |
...
| --- | ------------------- | ------------ |
| JN1_VRF1 | 100.64.21.15:11 | connected |
| JN2_VRF_1 | 100.64.21.15:21 | connected |
...
router bgp 65205
   ...
   neighbor 100.64.20.32 description dc2-spine1_Ethernet5
