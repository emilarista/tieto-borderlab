...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 10.83.31.243/22 | 10.83.28.1 |
...
| --------- | --------------- | ------------ | --------- |
| dc1-sleaf1 | Vlan4094 | 100.64.14.1 | Port-Channel2 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet2 | MLAG_PEER_dc1-sleaf1b_Ethernet2 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 2 |
| Ethernet3 | MLAG_PEER_dc1-sleaf1b_Ethernet3 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 2 |
| Ethernet4 | FIREWALL_Ethernet1 | *trunk | *1010,1111 | *- | *- | 4 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_DC1-SPINE1_Ethernet1 | routed | - | 100.64.10.1/31 | default | 1500 | false | - | - |
...
!
interface Ethernet2
   description MLAG_PEER_dc1-sleaf1b_Ethernet2
   no shutdown
   channel-group 2 mode active
!
interface Ethernet3
   description MLAG_PEER_dc1-sleaf1b_Ethernet3
   no shutdown
   channel-group 2 mode active
!
interface Ethernet4
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel2 | MLAG_PEER_dc1-sleaf1b_Po2 | switched | trunk | 2-4094 | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
interface Port-Channel2
   description MLAG_PEER_dc1-sleaf1b_Po2
   no shutdown
   switchport
...
| Vlan1010 |  BLUE  |  10.0.255.2/27  |  -  |  10.0.255.1  |  -  |  -  |  -  |
| Vlan1111 |  RED  |  10.0.254.2/27  |  -  |  10.0.254.1  |  -  |  -  |  -  |
| Vlan3009 |  BLUE  |  100.64.13.0/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan3010 |  RED  |  100.64.13.0/31  |  -  |  -  |  -  |  -  |  -  |
...
| 100.64.13.1 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | BLUE | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - |
| 10.0.255.4 | 1234 | BLUE | - | standard | 10000 | - | - | - |
| 100.64.13.1 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | RED | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 10 | 100.64.11.11:10010 | 64512:10010 | - | - | learned |
| 20 | 100.64.11.11:10020 | 64512:10020 | - | - | learned |
| 1010 | 100.64.11.11:11010 | 64512:11010 | - | - | learned |
| 1111 | 100.64.11.11:11111 | 64512:11111 | - | - | learned |

### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| BLUE | 100.64.11.11:10 | connected |
| RED | 100.64.11.11:11 | connected |
...
router bgp 65101
   ...
   neighbor MLAG-IPv4-UNDERLAY-PEER description dc1-sleaf1b
   ...
   neighbor 100.64.13.1 description dc1-sleaf1b
   redistribute connected route-map RM-CONN-2-BGP
   !
   vlan 10
      rd 100.64.11.11:10010
      route-target both 64512:10010
      redistribute learned
   !
   vlan 20
      rd 100.64.11.11:10020
      route-target both 64512:10020
      redistribute learned
   !
   vlan 1010
      rd 100.64.11.11:11010
      route-target both 64512:11010
      redistribute learned
   !
   vlan 1111
      rd 100.64.11.11:11111
